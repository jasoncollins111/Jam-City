...
role:"button",controls:b.$node[0].id+"_table"})+' title="'+(a?c.labelMonthNext:c.labelMonthPrev)+'"')},q=function(d){var e=c.showMonthsShort?c.monthsShort:c.monthsFull;return"short_months"==d&&(e=c.monthsShort),c.selectMonths&&void 0==d?f.node("select",f.group({min:0,max:11,i:1,node:"option",item:function(a){return[e[a],0,"value="+a+(k.month==a?" selected":"")+(k.year==m.year&&a<m.month||k.year==n.year&&a>n.month?" disabled":"")]}}),c.klass.selectMonth+" browser-default",(a?"":"disabled")+" "+f.ariaAttr({controls:b.$node[0].id+"_table"})+' title="'+c.labelMonthSelect+'"'):"short_months"==d?null!=i?f.node("div",e[i.month]):f.node("div",e[k.month]):f.node("div",e[k.month],c.klass.month)},r=function(d){var e=k.year,g=c.selectYears===!0?5:~~(c.selectYears/2);if(g){var h=m.year,i=n.year,j=e-g,l=e+g;if(h>j&&(l+=h-j,j=h),l>i){var o=j-h,p=l-i;j-=o>p?p:o,l=i}if(c.selectYears&&void 0==d)return f.node("select",f.group({min:j,max:l,i:1,node:"option",item:function(a){return[a,0,"value="+a+(e==a?" selected":"")]}}),c.klass.selectYear+" browser-default",(a?"":"disabled")+" "+f.ariaAttr({controls:b.$node[0].id+"_table"})+' title="'+c.labelYearSelect+'"')}return"raw"==d?f.node("div",e):f.node("div",e,c.klass.year)};return createDayLabel=function(){return null!=i?f.node("div",i.date):f.node("div",h.date)},createWeekdayLabel=function(){var a;a=null!=i?i.day:h.day;var b=c.weekdaysFull[a];return b},f.node("div",f.node("div",createWeekdayLabel(),"picker__weekday-display")+f.node("div",q("short_months"),c.klass.month_display)+f.node("div",createDayLabel(),c.klass.day_display)+f.node("div",r("raw"),c.klass.year_display),c.klass.date_display)+f.node("div",f.node("div",(c.selectYears?q()+r():q()+r())+p()+p(1),c.klass.header)+f.node("table",o+f.node("tbody",f.group({min:0,max:e-1,i:1,node:"tr",item:function(a){var e=c.firstDay&&0===b.create([k.year,k.month,1]).day?-7:0;return[f.group({min:d*a-k.day+e+1,max:function(){return this.min+d-1},i:1,node:"td",item:function(a){a=b.create([k.year,k.month,a+(c.firstDay?1:0)]);var d=i&&i.pick==a.pick,e=j&&j.pick==a.pick,g=l&&b.disabled(a)||a.pick<m.pick||a.pick>n.pick,o=f.trigger(b.formats.toString,b,[c.format,a]);return[f.node("div",a.date,function(b){return b.push(k.month==a.month?c.klass.infocus:c.klass.outfocus),h.pick==a.pick&&b.push(c.klass.now),d&&b.push(c.klass.selected),e&&b.push(c.klass.highlighted),g&&b.push(c.klass.disabled),b.join(" ")}([c.klass.day]),"data-pick="+a.pick+" "+f.ariaAttr({role:"gridcell",label:o,selected:d&&b.$node.val()===o?!0:null,activedescendant:e?!0:null,disabled:g?!0:null})),"",f.ariaAttr({role:"presentation"})]}})]}})),c.klass.table,'id="'+b.$node[0].id+'_table" '+f.ariaAttr({role:"grid",controls:b.$node[0].id,readonly:!0})),c.klass.calendar_container)+f.node("div",f.node("button",c.today,"btn-flat picker__today","type=button data-pick="+h.pick+(a&&!b.disabled(h)?"":" disabled")+" "+f.ariaAttr({controls:b.$node[0].id}))+f.node("button",c.clear,"btn-flat picker__clear","type=button data-clear=1"+(a?"":" disabled")+" "+f.ariaAttr({controls:b.$node[0].id}))+f.node("button",c.close,"btn-flat picker__close","type=button data-close=true "+(a?"":" disabled")+" "+f.ariaAttr({controls:b.$node[0].id})),c.klass.footer)},c.defaults=function(a){return{labelMonthNext:"Next month",labelMonthPrev:"Previous month",labelMonthSelect:"Select a month",labelYearSelect:"Select a year",monthsFull:["January","February","March","April","May","June","July","August","September","October","November","December"],monthsShort:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],weekdaysFull:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],weekdaysShort:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],weekdaysLetter:["S","M","T","W","T","F","S"],today:"Today",clear:"Clear",close:"Close",format:"d mmmm, yyyy",klass:{table:a+"table",header:a+"header",date_display:a+"date-display",day_display:a+"day-display",month_display:a+"month-display",year_display:a+"year-display",calendar_container:a+"calendar-container",navPrev:a+"nav--prev",navNext:a+"nav--next",navDisabled:a+"nav--disabled",month:a+"month",year:a+"year",selectMonth:a+"select--month",selectYear:a+"select--year",weekdays:a+"weekday",day:a+"day",disabled:a+"day--disabled",selected:a+"day--selected",highlighted:a+"day--highlighted",now:a+"day--today",infocus:a+"day--infocus",outfocus:a+"day--outfocus",footer:a+"footer",buttonClear:a+"button--clear",buttonToday:a+"button--today",buttonClose:a+"button--close"}}}(a.klasses().picker+"__"),a.extend("pickadate",c)}),function(a){function b(){var b=+a(this).attr("length"),c=+a(this).val().length,d=b>=c;a(this).parent().find('span[class="character-counter"]').html(c+"/"+b),e(d,a(this))}function c(b){var c=a("<span/>").addClass("character-counter").css("float","right").css("font-size","12px").css("height",1);b.parent().append(c)}function d(){a(this).parent().find('span[class="character-counter"]').html("")}function e(a,b){var c=b.hasClass("invalid");a&&c?b.removeClass("invalid"):a||c||(b.removeClass("valid"),b.addClass("invalid"))}a.fn.characterCounter=function(){return this.each(function(){var e=void 0!==a(this).attr("length");e&&(a(this).on("input",b),a(this).on("focus",b),a(this).on("blur",d),c(a(this)))})},a(document).ready(function(){a("input, textarea").characterCounter()})}(jQuery),angular.module("jamApp.controllers",[]).controller("JamController",["$scope","$location","$state","AddToSpotify","ArtistInfo","VenueSearch","Authentication","$timeout","City","$window",function($scope,$location,$state,AddToSpotify,ArtistInfo,VenueSearch,Authentication,$timeout,City,$window){function displayEvents(events){console.log("events ",events),$scope.eventsList=$scope.eventsList?$scope.eventsList:[];for(var nameCache={},i=0;i<events.length;i++)if(events[i].performance.length>0){var artist=events[i].performance[0].artist.displayName;nameCache[artist]||($scope.eventsList.push({artistName:artist,artistId:events[i].performance[0].artist.id,eventDateTime:{date:events[i].start.date,time:events[i].start.time},venue:events[i].venue.displayName,venueId:events[i].venue.id}),nameCache[artist]=!0)}$scope.obj={loading:!1}}$scope.obj={loading:!0},$scope.eventsList=[],$scope.artistAdded=!1;var getCityEventsIdThenUpdateEventsList=function(){City.getCity().then(function(id){return City.getCityEvents(id)}).then(function(events){return console.log("in events",events),events.data.resultsPage.results.event}).then(function(events){console.log("city",events[0].location.city),$scope.city=$scope.city?$scope.city:events[0].location.city,displayEvents(events)})};getCityEventsIdThenUpdateEventsList(),$scope.getVenue=function(venueName){$scope.artistClicked={},$state.go("artists"),$scope.obj={loading:!0};var venueId,venueName=$scope.text;VenueSearch.venueId(venueName).then(function(res){return venueId=res.data.resultsPage.results.venue[0].id,VenueSearch.venueEvents(venueId)}).then(function(res){console.log("venueEvents call returned",res);var events=res.data.resultsPage.results.event;$scope.eventsList=[],searchEvents(events)})},angular.element($window).bind("scroll",function(e){console.log("handling scroll event");var windowHeight="innerHeight"in window?window.innerHeight:document.documentElement.offsetHeight,body=document.body,html=document.documentElement,docHeight=Math.max(body.scrollHeight,body.offsetHeight,html.clientHeight,html.scrollHeight,html.offsetHeight);windowBottom=windowHeight+window.pageYOffset,windowBottom>=docHeight&&(console.log("getting some events!"),$timeout(getCityEventsIdThenUpdateEventsList,2500))}),$scope.artistDeets=function(artistClicked){var newId,artistId=artistClicked.artistId;ArtistInfo.getSpotifyIds(artistId).then(function(artistForeignId){return console.log("id ",artistForeignId),newId=artistForeignId.slice(15),ArtistInfo.getInfo(newId)}).then(function(info){"found your pic bruh"===info.status&&($scope.artistPic=info.image),$scope.artistClicked=artistClicked,console.log("current state ",$state.current),"artists.artist"!==$state.current.name&&$state.go("artists.artist")})["catch"](function(err){$scope.artistPic="http://cdn.playbuzz.com/cdn/71582f18-68a6-4ff0-942d-fd7090ffafd8/d56b4878-6ccb-4ce5-8101-f76d220a51d7.jpg",$scope.artistClicked=artistClicked,console.log("in ArtistDeets",artistClicked),"artists.artist"!==$state.current.name&&$state.go("artists.artist")})},$scope.logout=function(){Authentication.logOut().then(function(res){console.log("logged out")})},$scope.spotify=function(artist){var artistId=artist.artistId;ArtistInfo.getSpotifyIds(artistId).then(function(artistForeignId){var newId;if(""===artistForeignId)throw Error("no foreign Id");return newId=artistForeignId.slice(15),AddToSpotify.hotTracks(newId)}).then(function(addToSpotifyJammCityPlaylistStatus){if("tracks added!"!==addToSpotifyJammCityPlaylistStatus)throw Error("did not add to spotify");Materialize.toast("Popular music from "+artist.artistName+" was added to your Jamm-City playlist on Spotify",5750)})["catch"](function(err){Materialize.toast("We could not add "+artist.artistName+" to your Jamm-City playlist on Spotify :(...",5750)})}}]);var echokey="APRGVYHQGMQ5FKTYM",consumerKey="ce78d10e8183380fb57357cc8a07e29d",echoSharedSecret="YhNZOH5TRUWGMogv/2XCZw",songkickKey="ngIhxhYsLMjkEU8y";angular.module("jamApp.services",[]).factory("City",["$http","$q",function($http,$q){var jammCityIdPromise,page=1,getCityEvents=function(cityId){return $http.jsonp("https://api.songkick.com/api/3.0/metro_areas/"+cityId+"/calendar.json?apikey="+songkickKey+"&jsoncallback=JSON_CALLBACK&per_page=12&page="+page++)},getCityEventsLatng=function(lat,lng){return $http.jsonp("http://api.songkick.com/api/3.0/search/locations.json?location=geo:"+lat+","+lng+"&apikey="+songkickKey+"&jsoncallback=JSON_CALLBACK")},getCityId=function(){jammCityIdPromise=$q(function(resolve,reject){navigator.geolocation.getCurrentPosition(function(position){console.log("fixing to resolve promise"),resolve({lat:position.coords.latitude,lng:position.coords.longitude})},function(err){console.log("error getting position"),reject(err)})}).then(function(location){return getCityEventsLatng(location.lat,location.lng)}).then(function(cityInfo){var id=cityInfo.data.resultsPage.results.location[0].metroArea.id;return id})},getCity=function(){return jammCityIdPromise};return{getCityEvents:getCityEvents,getCityEventsLatng:getCityEventsLatng,getCityId:getCityId,getCity:getCity}}]).factory("ArtistInfo",["$http",function($http){function getSpotifyIds(songkickId){return $http.jsonp("http://developer.echonest.com/api/v4/artist/profile?api_key=APRGVYHQGMQ5FKTYM&id=songkick:artist:"+songkickId+"&bucket=id:spotify&format=jsonp&callback=JSON_CALLBACK").then(function(echonestData){console.log("echo response",echonestData);var echoArrOfForeignIds;return 0===echonestData.data.response.status.code&&echonestData.data.response.artist.foreign_ids?(echoArrOfForeignIds=echonestData.data.response.artist.foreign_ids,echoArrOfForeignIds.reduce(function(total,val){return"spotify"===val.catalog?val.foreign_id:total},"")):""})}function getInfo(artistId){return $http.get("/getArtist",{params:{artistId:artistId}}).then(function(response){return console.log("getArtist",response),response.data})}return{getSpotifyIds:getSpotifyIds,getInfo:getInfo}}]).factory("AddToSpotify",["$http",function($http){function hotTracks(artistId,cb){return $http.get("/hotTracks",{params:{artistId:artistId}}).then(function(response){return response.data.status})}return{hotTracks:hotTracks}}]).factory("VenueSearch",function($http){function venueId(venueName){return $http.jsonp("http://api.songkick.com/api/3.0/search/venues.json?query="+venueName+"&apikey="+songkickKey+"&jsoncallback=JSON_CALLBACK").success(function(data){console.log(data)})}function venueEvents(venueId){return $http.jsonp("http://api.songkick.com/api/3.0/venues/"+venueId+"/calendar.json?apikey="+songkickKey+"&jsoncallback=JSON_CALLBACK").success(function(data){console.log("venueEvents:",data)})}return{venueId:venueId,venueEvents:venueEvents}}).factory("Authentication",["$http","$state",function($http,$state){function isAuth(intendedState){return console.log("isAuth"),$http.get("/isAuthenticated").then(function(response){response.data.authenticated?($state.go(intendedState),isAuthenticated=!0):($state.go("login"),isAuthenticated=!1)},function(err){$state.go("login")})}function logOut(){$http.get("/logout").then(function(response){console.log(response)})}var isAuthenticated;return{isAuth:isAuth,isAuthenticated:isAuthenticated,logOut:logOut}}]),angular.module("jamApp",["jamApp.services","jamApp.controllers","ui.router"]).config(function($stateProvider,$urlRouterProvider){$urlRouterProvider.otherwise("/artists"),$stateProvider.state("artists",{url:"/artists",templateUrl:"app/artists/artists.html",controller:"JamController"}).state("artists.artist",{url:"/artist",templateUrl:"app/artist/artist.html"}).state("login",{url:"/login",templateUrl:"login.html"}).state("doBetter",{url:"/incompatibleBrowser",templateUrl:"incompatibleBrowser.html"})}).run(["$state","$http","Authentication","City",function($state,$http,Authentication,City){City.getCityId(),navigator.geolocation?Authentication.isAuth("artists"):$state.go("doBetter")}]).directive("artistCard",function(){return{templateUrl:"app/artist/artistCard.html"}}).directive("preloader",function(){return{templateUrl:"app/preloader/preloader.html"}}).directive("ajaxImg",["$http","ArtistInfo",function($http,ArtistInfo,$compile){var defaultImg="http://cdn.playbuzz.com/cdn/71582f18-68a6-4ff0-942d-fd7090ffafd8/d56b4878-6ccb-4ce5-8101-f76d220a51d7.jpg";return{scope:{artistId:"=ajaxImg",src:"=ngSrc"},link:function(scope,element,attrs,controllers){ArtistInfo.getSpotifyIds(scope.artistId).then(function(artistForeignId){return newId=artistForeignId.slice(15),ArtistInfo.getInfo(newId)}).then(function(info){"found your pic bruh"===info.status&&attrs.$set("ngSrc",info.image)})["catch"](function(err){attrs.$set("ngSrc",defaultImg)})}}}]);